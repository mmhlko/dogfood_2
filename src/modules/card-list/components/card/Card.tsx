...
export const Card = ({ name, price, discount, wight, description, pictures, tags, likes, _id, ...props }: any) => {
    ...
    return (
        ...
        <article className='card'>
            ...
            <div className="card__sticker card__sticker_type_top-right">
                <button onClick={handleClickButtonLike} className={classNames('card__favorite', { 'card__favorite_is-active': false })}>
                    <LikeIcon className='card__favorite-icon' />
                </button>
            </div>
